...
function(t) {
    ...
    function o(e, n) {
        ...
        for (var d in l)
            s.push(d + ":" + l[d]);
        if (s.push(n), s = s.join("|"), s in o.cache)
            return o.cache[s];
        var h = [];
        return t.each(l, function(e, a) {
            ...
            if (t.each(e.split(">"), function(t, a) {
                ...
                if (d = /^(\d\d)-(\d\d)$/.exec(a))
                    ...
                    parseInt(d[3], 10) == n && (h = new Date(n, parseInt(d[2], 10) - 1, parseInt(d[1], 10)));
                ...
                var d = [];
                if (s)
                    for (var p = new Date(o.getTime()); p.getTime() <= s.getTime(); p.setDate(p.getDate() + 1))
    ...
    function s(e, a, o, i) {
        ...
        o.slideUp("fast", function() {
            ...
            t("#cal-slide-tick").addClass("tick" + r).show(),
    ...
    n.prototype._render = function() {
        ...
        t.cal = this,
        t.day = 1,
        t.days_name = 1 == a(this, "first_day") ? [this.locale.d1, this.locale.d2, this.locale.d3, this.locale.d4, this.locale.d5, this.locale.d6, this.locale.d0] : [this.locale.d0, this.locale.d1, this.locale.d2, this.locale.d3, this.locale.d4, this.locale.d5, this.locale.d6];
    ...
    n.prototype._calculate_hour_minutes = function(e) {
        ...
        t.each(e.events, function(t, o) {
            ...
            if (o.start_hour = a._format_time(n), o.end_hour = a._format_time(s), o.start < p.getTime() && (i(1), o.start_hour = n.getDate() + " " + a.locale["ms" + n.getMonth()] + " " + o.start_hour), o.end > c.getTime() && (i(1), o.end_hour = s.getDate() + " " + a.locale["ms" + s.getMonth()] + " " + o.end_hour), o.start < p.getTime() && o.end > c.getTime())
                return e.all_day.push(o), void 0;
            if (o.end < p.getTime())
                return e.before_time.push(o), void 0;
            if (o.start > c.getTime())
                return e.after_time.push(o), void 0;
    ...
    n.prototype._week = function() {
        ...
        return t.each(this.getEventsBetween(o, i), function(t, e) {
            ...
            e.days = 864e5 >= e.end - e.start ? 1 : (e.end - e.start) / 864e5,
            o > e.start && (e.days = e.days - (o - e.start) / 864e5, e.start_day = 0),
    ...
    n.prototype._month = function(t) {
        ...
        var e = {
            ...
            a = t + 1;
        e.data_day = this.options.position.start.getFullYear() + "-" + (10 > a ? "0" + a : a) + "-" + "01",
    ...
    n.prototype._day = function(e, o) {
        ...
        2 == a(this, "first_day") ? s++ : s = 0 == s ? 7 : s,
        o = o - s + 1;
    ...
    n.prototype._getDayClass = function(t, e) {
        var a = this,
            o = function(e, o) {
                var i;
                i = a.options.classes && t in a.options.classes && e in a.options.classes[t] ? a.options.classes[t][e] : "",
    ...
    n.prototype.view = function(t) {
        if (t) {
            if (!this.options.views[t].enable)
                return;
            this.options.view = t
        }
        this._init_position(),
    ...
    n.prototype.navigate = function(e, a) {
        ...
        if ("next" == e)
            ...
            "today" == e ? o.start.setTime((new Date).getTime()) : t.error(this.locale.error_where.format(e));
        this.options.day = o.start.getFullYear() + "-" + o.start.getMonthFormatted() + "-" + o.start.getDateFormatted(),
        this.view(),
        _.isFunction(a) && a()
    },
    n.prototype._init_position = function() {
        ...
        if ("now" == this.options.day) {
            ...
            t.error(this.locale.error_dateformat.format(this.options.day));
        switch (this.options.view) {
        case "year":
            this.options.position.start.setTime(new Date(e, 0, 1).getTime()),
            this.options.position.end.setTime(new Date(e + 1, 0, 1).getTime());
            break;
        case "month":
            this.options.position.start.setTime(new Date(e, o, 1).getTime()),
            this.options.position.end.setTime(new Date(e, o + 1, 1).getTime());
            break;
        case "day":
            this.options.position.start.setTime(new Date(e, o, i).getTime()),
            this.options.position.end.setTime(new Date(e, o, i + 1).getTime());
            break;
        case "week":
            var r,
                l = new Date(e, o, i);
            r = 1 == a(this, "first_day") ? l.getDate() - (l.getDay() + 6) % 7 : l.getDate() - l.getDay(),
            this.options.position.start.setTime(new Date(e, o, r).getTime()),
            this.options.position.end.setTime(new Date(e, o, r + 7).getTime());
            break;
        default:
    ...
    n.prototype._update = function() {
        ...
        t("*[data-cal-date]").click(function() {
            ...
            e.options.day = t(this).data("cal-date"),
            e.view(a)
        }),
        ...
        if (t("a[data-event-id]", this.context).unbind("click"), e.options.modal) {
            ...
            if (a.length) {
                ...
                t("a[data-event-id]", this.context).on("click", function(i) {
                    ...
                    "iframe" == e.options.modal_type && (o.attr("src", n), t(".modal-body", a).html(o)),
                    (!a.data("handled.bootstrap-calendar") || a.data("handled.bootstrap-calendar") && a.data("handled.event-id") != i.id) && a.off("show.bs.modal").off("shown.bs.modal").off("hidden.bs.modal").on("show.bs.modal", function() {
                        ...
                        case "template":
                            ...
                            o.html(e.options.templates.modal({
                                event: i,
                                calendar: e
                            }))
                        }
                    ...
                    }).data("handled.bootstrap-calendar", !0).data("handled.event-id", i.id),
                    a.modal("show")
                })
            }
        }
    ...
    n.prototype._update_month = function() {
        ...
        if (1 == this.options.weekbox) {
            ...
            e.context.find(".cal-month-box .cal-row-fluid").on("mouseenter", function() {
                ...
                r = 10 > r ? "0" + r : r,
                o.html(e.locale.week.format(1 == e.options.display_week_numbers ? n.getWeek(a(e, "week_numbers_iso_8601")) : "")),
                o.attr("data-cal-week", i + r).show().appendTo(s)
            }).on("mouseleave", function() {
                o.hide()
            }),
            o.click(function() {
                e.options.day = t(this).data("cal-week"),
                e.view("week")
            })
        }
